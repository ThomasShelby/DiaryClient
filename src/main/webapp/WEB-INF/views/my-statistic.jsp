	...
	<tiles:putAttribute name="body">
		<div class="body">
			...
			<ul>
				...
				<li><b>Principal</b> :${pageContext.request.userPrincipal.name} </li>
			</ul>
			<button onclick="location.href='/DiaryClient'">Back</button>
		</div>
		<c:if test="'${pageContext.request.userPrincipal.name}' != '${user.nickName}'" ><a href="location.href='/DiaryClient/login'">Login as valid user </a></c:if>
	</tiles:putAttribute>
